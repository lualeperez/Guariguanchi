/***************************************************************************//**
 * @brief:      
 * @Description: Class for disk surfaces
 *
 *
...
#ifndef GSurfaceDisk_h
#define GSurfaceDisk_h
...
class GSurfaceDisk : public GSurfaceObject {
...
public:
  ...
  GSurfaceDisk(const GSurfaceDisk& other, TString Name = TString(""));
  ...
  void      GetURange(double V, double& Umin, double& Umax) {Umin = -TMath::Pi()*(V + 0.5*(Rout + Rin)); Umax = +TMath::Pi()*(V + 0.5*(Rout + Rin)); }
